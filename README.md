...
Репозиторий: [github.com/encoderstarting/yandex-maps-reviews](https://github.com/encoderstarting/yandex-maps-reviews).

Рабочий прототип: [85-193-80-2.sslip.io](https://85-193-80-2.sslip.io/).

Демо-доступ к публичному стенду:
...
При push в `main` и для pull request те же проверки автоматически запускаются в GitHub Actions. Laravel и Vue проверяются независимыми CI-задачами из `.github/workflows/ci.yml`.
...
- Публичный стенд размещён на одном VPS, поэтому не имеет отказоустойчивости кластера; для тестового задания это осознанное ограничение.
