...
Текущий результат включает рабочую аутентификацию, форму подключения компании, индикацию фоновой синхронизации, Laravel Sail, доменные таблицы, защищённый API, гибридный парсер и Redis queue. Подробный план находится в [`task.md`](task.md).
